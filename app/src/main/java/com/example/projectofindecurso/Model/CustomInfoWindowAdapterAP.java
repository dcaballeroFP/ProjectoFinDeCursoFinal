...
public class CustomInfoWindowAdapterAP implements GoogleMap.InfoWindowAdapter {
    ...
    public CustomInfoWindowAdapterAP(LayoutInflater inflater, String calleInformacion, String snippet){
    ...
    public View getInfoContents(final Marker m) {
        ...
        View v = inflater.inflate(R.layout.infowindow_layoutap, null);
